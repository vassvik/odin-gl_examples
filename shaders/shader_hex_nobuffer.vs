/*
	Vertex shader for rendering hexagons without any vertex buffers (no input)
...
void main() {
	vec2 p0 = hexagon(gl_VertexID, vec2(0.28867513459, 0.5)); // scaled so that the height is unity, and equal length sides
